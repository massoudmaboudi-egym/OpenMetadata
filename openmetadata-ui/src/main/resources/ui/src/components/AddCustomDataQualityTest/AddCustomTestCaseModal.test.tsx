...
import { EdgeInformationType } from '../Entity/EntityInfoDrawer/EntityInfoDrawer.interface';
import { AddCustomTestCaseModalProps } from './AddCustomDataQualityTest.interface';
import AddCustomTestCaseModal from './AddCustomTestCaseModal';

const mockProps: AddCustomTestCaseModalProps = {
  visible: true,
...
describe('AddCustomTestCaseModal Component', () => {
  it('component should render', async () => {
    render(<AddCustomTestCaseModal {...mockProps} />);
